...
1. Entrar em uma conta desenvolvedor da meta caso possua uma, caso contrário, se registrar com a conta do Facebookhttps://developers.facebook.com/async/registration.
